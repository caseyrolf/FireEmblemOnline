...
It now includes room-state persistence and reconnect recovery, but it still does not include authentication, base camp, shops, multi-map campaigns, or a map editor.
